"""
run_paid_simulator_phase2e_adjustment_viewer.py

Launcher for the standalone Phase 2E premium adjustment viewer.
"""
...
def main() -> int:
    ...
    print("=" * 96)
    print("Launching Phase 2E premium adjustment viewer")
    print("=" * 96)
